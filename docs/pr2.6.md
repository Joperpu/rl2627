# Práctica 2.6 - Red de hubs interconectados mediante un bridge

## Descripción de la tarea

Descarga el [siguiente guión](assets/pr2.6.pdf) de implementación de una red con hubs interconectados mediante un bridge en Cisco Packet Tracer, y realiza todos los pasos que en él se indican. Documenta todo con capturas de pantalla.

## Entrega

Crea un documento PDF, a partir de un Word o Google Docs, con las siguientes consideraciones:

- El nombre del archivo a entregar en la plataforma Moodle Centros debe tener el siguiente formato: `Apellido1Apellido2_Nombre_RL_UD2_P6.pdf`.
